...
function IdenticalHero({title, description, HeroImg}) {
    return (
        <div className="h-[40vh] md:h-screen flex flex-col lg:flex-row justify-between relative">
        ...
        <div className="w-full md:w-[46.8%] h-5 bg-red-600 absolute -bottom-3 md:bottom-0 pr-16"></div>
      </div>
    );
}
